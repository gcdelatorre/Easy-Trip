...
export function AirbnbCard() {
    ...
    return (
        ...
        >
            ...
            <div>
                <h3 className="font-serif text-lg text-foreground">Stays</h3>
                <p className="mt-1 text-sm text-muted-foreground">
                    Discover unique homes and stays in {currentTrip?.destination || "your destination"}
                </p>
            </div>
